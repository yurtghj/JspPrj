					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="text-align-left" style="padding:10px 0px 10px 10px;">
								${answeris.situation }<div><br></div><div style="text-align: center;"><img src="student/newlec/2018/2/image14113517png" style="max-width: 90%; max-height: 90%; border-width: 1px; border-style: solid; border-color: rgb(89, 89, 89);"><br></div><div><br></div><div><br></div><div><div>톰캣이 실행 안되는 이유도 분명하지 않고 이유도 모르겠다.&nbsp;</div><div><br></div><div>[조치해본 사항들]</div><div>1. 이클립스를 닫고 컴퓨터도 재부팅 해보았다. -&gt; 해결 안됨.</div><div>2. 톰캣 설정을 다시 해보았다.-&gt; 해결 안됨.</div></div>"""
							</td>
						</tr>
						<tr>
